...
class DbaController < ApplicationController
  ...
  def show_locks
    ...
    begin
      @ddl_count = sql_select_one "SELECT /* OPMS-Tool */ COUNT(*)
                                  FROM  dba_kgllock w,
                                        dba_kgllock h

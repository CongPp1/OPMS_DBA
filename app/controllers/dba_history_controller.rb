...
class DbaHistoryController < ApplicationController
  ...
  def list_segment_stat_historic_sum
    ...
    @segment_sums = sql_select_iterator ["
      ...
      SELECT /* OPMS-Tool */ s.Instance_Number,
  ...
  def list_binds_historic
    ...
    @binds = sql_select_all ["\
      SELECT /* OPMS-Tool */ Instance_Number, Name, Position, DataType_String, Last_Captured,
  ...
  def list_bind_samples_historic
    ...
    @binds = sql_select_iterator ["\
        SELECT /* OPMS-Tool */ b.Name, b.DataType_String, b.Last_Captured,
...
FROM (
  ...
  def list_system_events_historic_detail
    ...
    @snaps = sql_select_iterator ["
      SELECT /* OPMS-Tool */ snap.Begin_Interval_Time,
             Waits,
             Timeouts,
  ...
  def list_system_statistics_historic_full
    ...
    single_stats = sql_select_iterator ["
      ...
      SELECT /* OPMS-Tool */ Rounded_Begin_Interval_Time, MIN(Begin_Interval_Time) Min_Begin_Interval_Time, MAX(End_Interval_Time) Max_End_Interval_Time,
    ...
    statnames = sql_select_all ["
              SELECT /* OPMS-Tool */ h.Stat_ID, h.Stat_Name, n.Class Class_ID
  ...
  def list_system_statistics_historic_sum
    ...
    @statistics = sql_select_iterator ["
      ...
      SELECT /* OPMS-Tool */ name.Stat_Name, hist.Instance_Number, hist.Stat_ID, hist.Value, Min_Snap_ID, Max_Snap_ID, sn.Class Class_ID, hist.Snapshots
      FROM   (
  ...
  def list_system_statistics_historic_detail
    ...
    @snaps = sql_select_iterator ["
      SELECT /* OPMS-Tool */ snap.Begin_Interval_Time, snap.End_Interval_Time, Value
      FROM   (
              SELECT Snap_ID,
  ...
  def list_mutex_statistics_historic_Timeline
    @mutexes = sql_select_iterator ["\
      SELECT /* OPMS-Tool */ TRUNC(Sleep_Timestamp, 'MI') ts,
  ...
  def list_mutex_statistics_historic_samples
    ...
    @res = sql_select_all ["\
      SELECT /* OPMS-Tool */ Inst_ID, Mutex_Identifier, Sleep_Timestamp,
